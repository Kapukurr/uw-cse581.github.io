...
For each class, you should write a reading response as detailed [on this page](https://uw-cse581.github.io/readingresponses/).
...
* Take on the role of a [reporter](https://uw-cse581.github.io/discussion_roles/#reporter-aka-discussion-lead). This includes summarizing the key take-aways, running a background check on the authors, and preparing a few thought-provoking questions. 
...
* 15% Reading responses (see [this page](https://uw-cse581.github.io/readingresponses/) for how they are being graded)
